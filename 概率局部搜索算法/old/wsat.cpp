...
int cpick_skc()
{
	...
	{
		if (sat_count[ci]==1) ++bbreakv;//表明会被break子句
	}
...
int run_cnf(int argc, char* argv[])
{
	...
	{
		init();
		//cout<<"--------开始满足："<<double(num_clauses_h-unsat_stack_fill_pointer)/num_clauses_h<<endl;
