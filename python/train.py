...
parser.add_argument('--run_id', action='store', dest='run_id', type=int, default=100)
parser.add_argument('--restore_id', action='store', dest='restore_id', type=int, default=100)
parser.add_argument('--restore_epoch', action='store', dest='restore_epoch', type=int, default=158)
parser.add_argument('--n_epochs', action='store', dest='n_epochs', type=int, default=100000, help='Number of epochs through data')
parser.add_argument('--n_saves_to_keep', action='store', dest='n_saves_to_keep', type=int, default=1000000, help='Number of saved models to keep')
