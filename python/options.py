...
def add_neurosat_options(parser):
    parser.add_argument('--d', action='store', dest='d', type=int, default=256, help='Dimension of variable and clause embeddings')
    ...
    parser.add_argument('--n_msg_layers', action='store', dest='n_msg_layers', type=int, default=13, help='Number of layers in message MLPs')
