...
class Problem(object):
    def __init__(self, n_vars, iclauses, is_sat, n_cells_per_batch, all_dimacs,lclause):
        self.n_vars = n_vars
...
def mk_batch_problem(problems):
    ...
    for dimacs, n_vars, iclauses, is_sat in problems:
        ...
        offset += n_vars
        lclause.append(len(iclauses))
    return Problem(offset, all_iclauses, all_is_sat, all_n_cells, all_dimacs,lclause)
